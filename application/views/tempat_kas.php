		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="normal-table-list">
				<div class="basic-tb-hd">
					<form method="POST" action="<?php echo base_url().'kas/tambah_tempat_kas' ?>">
						<div class="row">
							<div class="col-md-12">
					...
					<table class="table table-sc-ex">
						...
						<tbody>
							...
							<tr>
								...
								<form method="POST" action="<?php echo base_url().'kas/update_tempat_kas/'.$k['id'] ?>">
								<td style="width:25%;">
									<div class="nk-int-st">
								...
								<td style="width:25%;">
									...
									<a href='<?php echo base_url().'persedian_page/delete_item/tempat_kas/'.$k['id']; ?>' onclick="return confirm('Are you sure delete this item?');"><span class="btn btn-danger fa fa-trash-o"> Hapus</span></a>
								</td>
								</form>	
							</tr>
							<?php } ?>
